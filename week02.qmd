...
4.  Perform set operations using `UNION`, `UNION ALL`, `EXCEPT` and `INTERSECT`. [📔 Notebook 2.4](week02-04-union.ipynb)
...
::: source
[Library Case Notebook](/week02-library.ipynb)
:::

::: source
[Notes for W02 Notebook](/week02-notes.ipynb)
:::
