...
<center>
<figure>
    <img src="imgs/grading.jpeg"
         alt="Created by AI Prompt: create a piece of art that echoes grading inside the classroom"
         width="350"  >
...
<!-- These methods need better explanation -->


## Step 0. Prepare

- Click this [link](https://classroom.github.com/a/WiX09fHf) and then "Accept this assignment".
...
| 100 	| 95 	| 93 	| 89 	| 87 	| 70 	| 49 	| 22 	| 19 	| 17 	|
|-----	|----	|----	|----	|----	|----	|----	|----	|----	|----	|
...
| 100 	| 95 	| 93 	| 89 	| 87 	| [77]{style="color: red"} 	| 70 	| 49 	| 22 	| 19 	|
|-----	|----	|----	|----	|----	|----	|----	|----	|----	|----	|
...
|------------------------	|-------------------	|--------------------------------------------------------	|
| findLocationToInsert() 	| int newScore      	| int: the index of where to insert the newScore, or -1 if the score is not a new high score. 	|
| shiftUp()              	| int fromIndex 	    | void                                                     	|
...
You might find it really useful to create a function to print out the high scores in the object. Then, you can call that function from various places to see what the array really holds.
