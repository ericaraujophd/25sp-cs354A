...
- Click [this link](https://classroom.github.com/a/_TFPzkme) and then "Accept this assignment".
...
<!-- - You might at this time also share the repo in github.com with the partner. -->
...
Begin by **commenting out all of the Vec prototypes**, and ****all of the method definitions you just pasted into the header file**. If you want to, compile (`make tester`) and run your project(`./tester`). You should see the message indicating there are no tests.
