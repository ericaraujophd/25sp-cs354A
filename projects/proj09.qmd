---
title: "Project 9: Using Queues to Implement the Snake Game"
format: 
  html:
...
<img src="/projects/imgs/proj9-snake.png" alt="Created by AI Prompt: Here’s an illustration of a stylized depiction of the Snake game in a retro pixel-art aesthetic." width="400"/>
<figcaption>Created by AI Prompt: Here’s an illustration of a stylized depiction of the Snake game in a retro pixel-art aesthetic.</figcaption>
...
[Accept the assignment](https://classroom.github.com/a/y1MFWgHx) and use `git clone` to create your copy of the code.
...
![Button to connect to game](/projects/imgs/proj9-button.png)
...
Recall that you can get your username and id from the bridges website: [http://bridges-cs.herokuapp.com/](http://bridges-cs.herokuapp.com/)
