...
<img src="/images/projects/proj10-snake.png" alt="Created by AI Prompt: Here’s an illustration of a stylized depiction of the Snake game in a retro pixel-art aesthetic." width="400"/>
...
[Accept the assignment](){target="_blank"} and use `git clone` to create your copy of the code. Make sure you and your partner are in the same Team.
