...
<div class="tg-wrap"><table class="tg"><thead>
  <tr>
    <th class="tg-1wig"><span style="color:unset;background-color:unset">Method name</span></th>
    <th class="tg-1wig"><span style="color:unset;background-color:unset">parameters</span></th>
    <th class="tg-1wig"><span style="color:unset;background-color:unset">return type</span></th>
  </tr></thead>
<tbody>
  <tr>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">findLocationToInsert()</span></td>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">int newScore</span></td>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">int: the index of where to insert the newScore, or -1 if the score is not a new high score.</span></td>
  </tr>
  <tr>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">shiftUp()</span></td>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">int fromIndex</span></td>
    <td class="tg-0lax"><span style="color:unset;background-color:unset">void</span></td>
  </tr>
</tbody></table></div>
