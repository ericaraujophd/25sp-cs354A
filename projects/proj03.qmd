...
[Method name]{style="color:unset;background-color:unset"}

</th>

<th class="tg-1wig">

[parameters]{style="color:unset;background-color:unset"}

</th>

<th class="tg-1wig">

[return type]{style="color:unset;background-color:unset"}
...
[findLocationToInsert()]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[int newScore]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[int: the index of where to insert the newScore, or -1 if the score is not a new high score.]{style="color:unset;background-color:unset"}
...
[shiftUp()]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[int fromIndex]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[void]{style="color:unset;background-color:unset"}
