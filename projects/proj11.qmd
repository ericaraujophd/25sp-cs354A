---
title: "Project 10: Binary Search Trees"
format: 
  html:
...
<img src="/images/projects/proj10-header.png" alt="Created by AI Prompt: Here is the illustration of a scientist creating a binary search tree with random numbers in a futuristic lab setting." width="400"/>

<figcaption>Here is the illustration of a scientist creating a binary search tree with random numbers in a futuristic lab setting.</figcaption>
...
[Accept the assignment](https://classroom.github.com/a/Pud8TSjT) and use `git clone` to create your copy of the code.
