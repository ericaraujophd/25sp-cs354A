...
|--------------|------------------|--------------|--------------|--------------|
| 0 <br> --- <br> 1/21 | Intro to C++, compilation, Data Types (including pointers), const, binary and hexadecimal, arrays, using cout/cin. <br> [Week's page](/week00.qmd) | [Lab 0](/labs/lab00.qmd){target="_blank"} | [Proj 0](/projects/proj00.qmd){target="_blank"} |  |
| 1 <br> --- <br> 1/27 | Control Structures, Functions, Parameter Passing modes. <br>[Week's page](/week01.qmd) | [Lab 1](/labs/lab01.qmd) | [Proj 1]() |  |
| 2 <br> --- <br> 2/3 | File Input/Output, Exception Handling, Two-dimensional Arrays. <br>[Week's page](/week02.qmd) | [Lab 2]() | [Proj 2]() |  |
