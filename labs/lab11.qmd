...
Modify **BST.h** as necessary to fix any compilation/linking errors, using an approach similar to the approach used in `insert()`. Recompile and run the tests. If you get stuck, here is a [hint](./lab11-hint2.qmd){target="_blank"}, but don't use it unless you have to.
