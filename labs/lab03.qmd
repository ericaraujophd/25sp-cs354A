...
[Instance Variable Name]{style="color:unset;background-color:unset"}

</th>

<th class="tg-1wig">

[Type]{style="color:unset;background-color:unset"}

</th>

<th class="tg-1wig">

[Default value]{style="color:unset;background-color:unset"}

</th>

<th class="tg-1wig">

[Notes]{style="color:unset;background-color:unset"}
...
[myName]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[string]{style="color:unset;background-color:unset"}
...
[Immutable (NOTE: this]{style="color:unset;background-color:unset"} [is not]{style="font-weight:bolder"} [a const in our class, but we will]{style="color:unset;background-color:unset"} [not]{style="font-weight:bolder"} [be making setter functions for these immutable values.)]{style="color:unset;background-color:unset"}
...
[myId]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[unsigned int]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[0]{style="color:unset;background-color:unset"}
...
[myGpa]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[float]{style="color:unset;background-color:unset"}

</td>

<td class="tg-0lax">

[0.0]{style="color:unset;background-color:unset"}
...
[myMajor]{style="color:unset;background-color:unset"}
...
[“Undecided”]{style="color:unset;background-color:unset"}
