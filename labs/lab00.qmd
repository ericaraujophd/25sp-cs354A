...
![](/images/labs/lab00-error-tester.png)

If I click on the red <span style="color:red">**X**</span>, I see this:

![](/images/labs/lab00-all-checks-failed.png)

To see the steps to get your errors report, see video below.

![](/images/labs/lab00-errors.gif)

Click on <span style="color:blue">**Details**</span> to see information about what automated test failed. In this case, there is only 1 automated test, so if it fails your output is not what is expected.
...
If you have problems, you should go back and fix them, and then resubmit until the automated test passes.
When you are done, you are free to go. Be sure to logout from your workstation, so that no one plays any pranks with your account!
