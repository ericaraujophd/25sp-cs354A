...
<img src="/images/labs/lab00-soitbegins.gif" alt="LOtR warm up." width="700"/>
...
Click on the  invitation for this lab: [https://classroom.github.com/a/QYJE3sJ0](https://classroom.github.com/a/QYJE3sJ0){target="_blank"}
...
![](/images/labs/lab00-InstallCpp.gif)
...
![](/images/labs/lab00-Cpp-Settings.gif)
...
In your main(), define a variable name of type string, and initialize it to your name by asking for an input from the keyboard (take a look at the cin command in C++). When you run your executable, it will be waiting for you to type your name and hit Enter! Note: strings are surrounded by double quotes in C++. But in the case of entering them by using cin, double quotes are unnecessary.
...
Make sure you put the exclamation point on the end. Now, try recompiling and running ./lab0
Now, create a second file called utils.cpp and in there, put this code:
 ...
 int courseNumber() {
 	...
 	int courseNumber();
In your main.cpp file, add #include "utils.h" to the area where you have #include <iostream>.  NOTE: use "utils.h" not <utils.h>
...
❗❗❗NOTE NOTE NOTE: if you do not submit your code, the grader cannot see it and grade it! Do not forget to do this step!
...
In VS Code, click on the Source Control icon on the upper left and type in a commit message, then click the checkmark icon to submit your code. Go through the various pop-up boxes to commit and push your changes to your online repo.
	When you push your changes to your online repo, a set of automated tests may be run (Prof. Norman is adding automated tests to most labs and projects). To find out if your automated tests passed, look at your online repo. If you see a green checkmark, tests have passed! But, in mine, I see this:
